                ...
                >
                  ...
                  <motion.div variants={sidebarItem} className="flex flex-col sm:flex-row sm:items-center gap-6 mb-2">
                    <div className="relative flex-shrink-0 w-max">
                      <div className="absolute -inset-[4px] rounded-full" style={{ background: 'linear-gradient(135deg, rgba(100,255,218,0.5), rgba(129,140,248,0.3))', filter: 'blur(5px)' }} />
                      <div className="relative w-32 h-47 rounded-full overflow-hidden border-[3px] flex-shrink-0" style={{ borderColor: 'rgba(100,255,218,0.3)' }}>
                        <img src="/jay.png" alt="Jay Niketan Pathare" className="w-full h-full object-cover" style={{ objectPosition: '50% 15%' }} />
                      </div>
                    </div>
                    <div>
...
<section id="projects" className="scroll-mt-24">
                    ...
                    <motion.div className="grid grid-cols-1 xl:grid-cols-2 gap-4" initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-60px' }} variants={listVariants}>
                      ...
                      <ProjectCard
                        date="Apr 2026"
                        icon="OCR" title="AI Metadata Extraction Pipeline" href="https://github.com/jaypathare/temp-ocr-repo"
                      ...
                      <ProjectCard
                        date="Mar 2026"
                        icon="GNN" title="Fraud Detection with Graph Neural Networks" href="https://github.com/jaypathare/fraud-detection-gnn"
